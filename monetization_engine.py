...
def render_paywall_modal(feature_name="Feature Pro"):
    ...
    html_code = f"""<div style="background: linear-gradient(135deg, rgba(15, 23, 42, 0.98) 0%, rgba(30, 58, 138, 0.6) 100%); border: 2px solid rgba(0, 242, 254, 0.4); border-radius: 20px; padding: 28px; margin: 24px 0; box-shadow: 0 15px 40px rgba(0,242,254,0.15); text-align: center;">
...
<p style="color: #94A3B8; font-size: 14px; max-width: 600px; margin: 0 auto 20px auto;">La funzione <b>{feature_name}</b> (ricerca ticker illimitata, storico 2010-2026, breakdown trimestrali Q1-Q4 ed export CSV) è riservata agli abbonati Pro.</p>
...
<div style="background: linear-gradient(90deg, #00F2FE 0%, #4FACFE 100%); color: #0F172A; font-weight: 800; padding: 10px 18px; border-radius: 10px; font-size: 13px; margin-top: 8px; box-shadow: 0 0 15px rgba(0,242,254,0.4);">Abbonati a €4,99 (Stripe)</div>
</a>
</div>
...
<div style="background: linear-gradient(90deg, #00FF7F 0%, #10B981 100%); color: #0F172A; font-weight: 800; padding: 10px 18px; border-radius: 10px; font-size: 13px; margin-top: 8px; box-shadow: 0 0 15px rgba(0,255,127,0.4);">Abbonati Annuale (Stripe)</div>
</a>
</div>
</div>
</div>"""
...
def render_broker_affiliate_card(ticker: str):
    ...
    html_code = f"""<div style="background: rgba(15, 23, 42, 0.7); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 20px; margin: 24px 0;">
...
<div style="background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.15); color: #FFFFFF; font-weight: 700; padding: 8px 14px; border-radius: 8px; font-size: 12px;">🏛️ Interactive Brokers</div>
</a>
<a href="{BROKER_AFFILIATE_LINKS['Trade Republic']}" target="_blank" style="text-decoration: none;">
<div style="background: rgba(0, 242, 254, 0.1); border: 1px solid rgba(0, 242, 254, 0.3); color: #00F2FE; font-weight: 700; padding: 8px 14px; border-radius: 8px; font-size: 12px;">📱 Trade Republic</div>
</a>
<a href="{BROKER_AFFILIATE_LINKS['eToro']}" target="_blank" style="text-decoration: none;">
<div style="background: rgba(0, 255, 127, 0.1); border: 1px solid rgba(0, 255, 127, 0.3); color: #00FF7F; font-weight: 700; padding: 8px 14px; border-radius: 8px; font-size: 12px;">🌐 eToro</div>
</a>
</div>
</div>
</div>"""
